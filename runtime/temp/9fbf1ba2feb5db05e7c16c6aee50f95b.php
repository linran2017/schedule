<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\phpstudy\WWW\duty\public/../application/admin\view\person\store.html";i:1513778933;s:53:"D:\phpstudy\WWW\duty\application\admin\view\base.html";i:1513755622;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="panel-body">
        ...
        <form style="margin-top: 10px;" action="" method="post" class="form-horizontal" role="form">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label for="inputID" class="col-sm-2 control-label">员工名称:</label>
                        <div class="col-sm-10">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php if(is_array($task) || $task instanceof \think\Collection || $task instanceof \think\Paginator): if( count($task)==0 ) : echo "" ;else: foreach($task as $key=>$v): ?>
                    <div class="panel panel-default">
                        <div class="panel-heading">
