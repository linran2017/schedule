<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\phpstudy\WWW\duty\public/../application/admin\view\person\index.html";i:1513818068;s:53:"D:\phpstudy\WWW\duty\application\admin\view\base.html";i:1513755622;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="panel-body">
        ...
        <table class="table table-hover">
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo url('edit',['id'=>$v['id']]); ?>" class="btn btn-primary">编辑</a>
                    <a href="javascript:;" onclick="del(<?php echo $v['id']; ?>)" class="btn btn-danger">删除</a>
                </td>
            </tr>
