<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\phpstudy\WWW\duty\public/../application/admin\view\task\edit.html";i:1513751562;s:53:"D:\phpstudy\WWW\duty\application\admin\view\base.html";i:1513755622;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="panel-body">
        ...
        <form style="margin-top: 10px;" action="" method="post" class="form-horizontal" role="form">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="title" id="inputID" class="form-control" value="<?php echo $oldData['title']; ?>" title="">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="radio">
                        <label>
                            <input type="radio" name="status" id="inputID" value="0" <?php if($oldData['status']==0): ?> checked="checked" <?php endif; ?>>
                            未完成
                        </label>
                        <label>
                            <input type="radio" name="status" id="inputID" value="1" <?php if($oldData['status']==1): ?> checked="checked" <?php endif; ?>>
                            已完成
                        </label>
                    </div>
                </div>
            </div>
            <input type="hidden" name="tid" value="<?php echo input('param.id'); ?>" >
            <div class="form-group">
